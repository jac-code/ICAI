 function [B2,B3,P4,B5,B6,P7,B8,B9,I10]=GOP_gris(i, mov)
        %reading P4 frame
        %framedata=aviread('news.avi',i+3);
        framedata=mov(i+3).cdata;
        P4=framedata;
